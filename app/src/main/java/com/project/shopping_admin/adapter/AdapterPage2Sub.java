...
public class AdapterPage2Sub extends RecyclerView.Adapter<AdapterPage2Sub.ViewHolderClass>    {
   ...
   // List<String> list;
    ...
    public AdapterPage2Sub(Context context,  List<model_img_and_stkid> list2) {
