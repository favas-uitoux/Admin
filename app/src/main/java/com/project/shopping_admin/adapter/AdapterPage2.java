...
public class AdapterPage2 extends RecyclerView.Adapter<AdapterPage2.ViewHolderClass> implements AdapterPage2Interface {
    ...
    public AdapterPage2(Context context, List<DetailsItem> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderClass holder, int position) {
        ...
        holder.btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Constants.getPage2FragInterface().show_dialog(cpr.getStkidFromServer());

                //   Page2Fragment().showDialog2();
        ...
        adp = new AdapterPage2Sub(context, list3);
